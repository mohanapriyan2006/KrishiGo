					...
					<View className="flex-1 justify-center px-8 relative">
						...
						<View className="bg-white/80 backdrop-blur-lg rounded-3xl p-6 shadow-xl">
							...
							<View className="mb-2">
								...
								<TextInput
									className={`w-full bg-white rounded-xl px-4 py-4 text-base border ${
							...
							<View className="mb-8">
								...
								<View className="relative">
									<TextInput
										className={`w-full bg-white rounded-xl px-4 py-4 pr-12 text-base border ${
							...
							{/* Login Button */}
							<TouchableOpacity
								className={`w-full bg-primary rounded-xl py-2 mb-4 shadow-lg ${
									loading ? "opacity-70" : ""
								}`}
								onPress={handleLogin}
								disabled={loading}
